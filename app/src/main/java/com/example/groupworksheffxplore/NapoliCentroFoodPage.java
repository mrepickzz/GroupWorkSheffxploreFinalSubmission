...
public class NapoliCentroFoodPage extends AppCompatActivity {
    ...
    private ImageView NapoliCentro1;
    private ImageView NapoliCentro2;
    private ImageView NapoliCentro3;
    private ImageView NapoliCentro4;
    private ImageView NapoliCentro5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_napoli_centro_food_info);
        slidr = Slidr.attach(this);
        ratingsDataBaseHelper = new RatingsDataBaseHelper(this);
        createNotificationChannel();


        this.buttonMaps = (Button) this.findViewById(R.id.button_maps_napoli);
        this.buttonFeedback = (Button) this.findViewById(R.id.button_feedback_napoli);
        this.buttonSubmit = (Button) this.findViewById(R.id.button_submit_napoli);
        this.ratingBarYours = (RatingBar) this.findViewById(R.id.ratingBar_yours_napoli);
        this.ratingBarAll = (RatingBar) this.findViewById(R.id.ratingBar_all_napoli);

        this.textViewYourCurrentRating = (TextView) this.findViewById(R.id.textView_yourCurrentRating_napoli);
        this.textViewRatingCount= (TextView) this.findViewById(R.id.textView_ratingCount_napoli);
        this.textViewSumAllRating= (TextView) this.findViewById(R.id.textView_sumAllRating_napoli);
        this.textViewAverageAllRating= (TextView) this.findViewById(R.id.textView_averageAllRating_napoli);
        ...
        if(isServicesOK()){
            buttonMaps.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(com.example.groupworksheffxplore.NapoliCentroFoodPage.this, MapActivity.class);
    ...
    public boolean isServicesOK(){
        ...
        int available = GoogleApiAvailability.getInstance().isGooglePlayServicesAvailable(com.example.groupworksheffxplore.NapoliCentroFoodPage.this);
        ...
        if(available == ConnectionResult.SUCCESS){
            ...
            Dialog dialog = GoogleApiAvailability.getInstance().getErrorDialog(com.example.groupworksheffxplore.NapoliCentroFoodPage.this, available, ERROR_DIALOG_REQUEST);
            dialog.show();
        }else {
