...
public class CommonRoomBarPage extends AppCompatActivity {
    ...
    private ImageView commonroom1;
    private ImageView commonroom2;
    private ImageView commonroom3;
    private ImageView commonroom4;
    private ImageView commonroom5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_commonroom_bar_info);
        slidr = Slidr.attach(this);
        ratingsDataBaseHelper = new RatingsDataBaseHelper(this);
        createNotificationChannel();

        this.commonroom1 = (ImageView) this.findViewById(R.id.commonroom1);
        this.commonroom2 = (ImageView) this.findViewById(R.id.commonroom2);
        this.commonroom3 = (ImageView) this.findViewById(R.id.commonroom3);
        this.commonroom4 = (ImageView) this.findViewById(R.id.commonroom4);
        this.commonroom5 = (ImageView) this.findViewById(R.id.commonroom5);
        this.buttonMaps = (Button) this.findViewById(R.id.button_maps_commonroom);
        this.buttonFeedback = (Button) this.findViewById(R.id.button_feedback_commonroom);
        this.buttonSubmit = (Button) this.findViewById(R.id.button_submit_commonroom);
        this.ratingBarYours = (RatingBar) this.findViewById(R.id.ratingBar_yours_commonroom);
        this.ratingBarAll = (RatingBar) this.findViewById(R.id.ratingBar_all_commonroom);

        this.textViewYourCurrentRating = (TextView) this.findViewById(R.id.textView_yourCurrentRating_commonroom);
        this.textViewRatingCount = (TextView) this.findViewById(R.id.textView_ratingCount_commonroom);
        this.textViewSumAllRating = (TextView) this.findViewById(R.id.textView_sumAllRating_commonroom);
        this.textViewAverageAllRating = (TextView) this.findViewById(R.id.textView_averageAllRating_commonroom);
        ...
        if (isServicesOK()) {
            buttonMaps.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(CommonRoomBarPage.this, MapActivity.class);
    ...
    public boolean isServicesOK() {
        ...
        int available = GoogleApiAvailability.getInstance().isGooglePlayServicesAvailable(CommonRoomBarPage.this);
        ...
        if (available == ConnectionResult.SUCCESS) {
            ...
            Dialog dialog = GoogleApiAvailability.getInstance().getErrorDialog(CommonRoomBarPage.this, available, ERROR_DIALOG_REQUEST);
            dialog.show();
        } else {
