...
public class CrookesValleyParkPage extends AppCompatActivity {
    ...
    private ImageView crookesValley1;
    private ImageView crookesValley2;
    private ImageView crookesValley3;
    private ImageView crookesValley4;
    private ImageView crookesValley5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_crookesvalley_park_info);
        slidr = Slidr.attach(this);
        ratingsDataBaseHelper = new RatingsDataBaseHelper(this);
        createNotificationChannel();


        this.buttonMaps = (Button) this.findViewById(R.id.button_maps_crookesValley);
        this.buttonFeedback = (Button) this.findViewById(R.id.button_feedback_crookesValley);
        this.buttonSubmit = (Button) this.findViewById(R.id.button_submit_crookesValley);
        this.ratingBarYours = (RatingBar) this.findViewById(R.id.ratingBar_yours_crookesValley);
        this.ratingBarAll = (RatingBar) this.findViewById(R.id.ratingBar_all_crookesValley);

        this.textViewYourCurrentRating = (TextView) this.findViewById(R.id.textView_yourCurrentRating_crookesValley);
        this.textViewRatingCount= (TextView) this.findViewById(R.id.textView_ratingCount_crookesValley);
        this.textViewSumAllRating= (TextView) this.findViewById(R.id.textView_sumAllRating_crookesValley);
        this.textViewAverageAllRating= (TextView) this.findViewById(R.id.textView_averageAllRating_crookesValley);
        ...
        if(isServicesOK()){
            buttonMaps.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(com.example.groupworksheffxplore.CrookesValleyParkPage.this, MapActivity.class);
    ...
    public boolean isServicesOK(){
        ...
        int available = GoogleApiAvailability.getInstance().isGooglePlayServicesAvailable(com.example.groupworksheffxplore.CrookesValleyParkPage.this);
        ...
        if(available == ConnectionResult.SUCCESS){
            ...
            Dialog dialog = GoogleApiAvailability.getInstance().getErrorDialog(com.example.groupworksheffxplore.CrookesValleyParkPage.this, available, ERROR_DIALOG_REQUEST);
            dialog.show();
        }else {
