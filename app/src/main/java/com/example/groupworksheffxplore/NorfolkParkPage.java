...
public class NorfolkParkPage extends AppCompatActivity {
    ...
    private ImageView norfolk1;
    private ImageView norfolk2;
    private ImageView norfolk3;
    private ImageView norfolk4;
    private ImageView norfolk5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mScaleGestureDetector = new ScaleGestureDetector(this,new NorfolkParkPage.ScaleListener());
        ratingsDataBaseHelper = new RatingsDataBaseHelper(this);
        createNotificationChannel();

        this.norfolk1 = (ImageView) this.findViewById(R.id.norfolk1);
        this.norfolk2 = (ImageView) this.findViewById(R.id.norfolk2);
        this.norfolk3 = (ImageView) this.findViewById(R.id.norfolk3);
        this.norfolk4 = (ImageView) this.findViewById(R.id.norfolk4);
        this.norfolk5 = (ImageView) this.findViewById(R.id.norfolk5);
        this.buttonMaps = (Button) this.findViewById(R.id.button_maps_norfolk);
        this.buttonFeedback = (Button) this.findViewById(R.id.button_feedback_norfolk);
        this.buttonSubmit = (Button) this.findViewById(R.id.button_submit_norfolk);
        this.ratingBarYours = (RatingBar) this.findViewById(R.id.ratingBar_yours_norfolk);
        this.ratingBarAll = (RatingBar) this.findViewById(R.id.ratingBar_all_norfolk);

        this.textViewYourCurrentRating = (TextView) this.findViewById(R.id.textView_yourCurrentRating_norfolk);
        this.textViewRatingCount= (TextView) this.findViewById(R.id.textView_ratingCount_norfolk);
        this.textViewSumAllRating= (TextView) this.findViewById(R.id.textView_sumAllRating_norfolk);
        this.textViewAverageAllRating= (TextView) this.findViewById(R.id.textView_averageAllRating_norfolk);
        ...
        if(isServicesOK()){
            buttonMaps.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(NorfolkParkPage.this, MapActivity.class);
    ...
    public boolean isServicesOK(){
        ...
        int available = GoogleApiAvailability.getInstance().isGooglePlayServicesAvailable(NorfolkParkPage.this);
        ...
        if(available == ConnectionResult.SUCCESS){
            ...
            Dialog dialog = GoogleApiAvailability.getInstance().getErrorDialog(NorfolkParkPage.this, available, ERROR_DIALOG_REQUEST);
            dialog.show();
        }else {
    ...
    private class ScaleListener extends ScaleGestureDetector.
        ...
        public boolean onScale(ScaleGestureDetector detector) {
            ...
            norfolk1.setImageMatrix(matrix);
            return true;
        }
