...
public class WestStreetLiveBarMenu extends AppCompatActivity {
    ...
    private ImageView wessies1;
    private ImageView wessies2;
    private ImageView wessies3;
    private ImageView wessies4;
    private ImageView wessies5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wessies_bar_info);
        slidr = Slidr.attach(this);
        ratingsDataBaseHelper = new RatingsDataBaseHelper(this);
        createNotificationChannel();

        this.wessies1 = (ImageView) this.findViewById(R.id.wessies1);
        this.wessies2 = (ImageView) this.findViewById(R.id.wessies2);
        this.wessies3 = (ImageView) this.findViewById(R.id.wessies3);
        this.wessies4 = (ImageView) this.findViewById(R.id.wessies4);
        this.wessies5 = (ImageView) this.findViewById(R.id.wessies5);
        this.buttonMaps = (Button) this.findViewById(R.id.button_maps_wessies);
        this.buttonFeedback = (Button) this.findViewById(R.id.button_feedback_wessies);
        this.buttonSubmit = (Button) this.findViewById(R.id.button_submit_wessies);
        this.ratingBarYours = (RatingBar) this.findViewById(R.id.ratingBar_yours_wessies);
        this.ratingBarAll = (RatingBar) this.findViewById(R.id.ratingBar_all_wessies);

        this.textViewYourCurrentRating = (TextView) this.findViewById(R.id.textView_yourCurrentRating_wessies);
        this.textViewRatingCount= (TextView) this.findViewById(R.id.textView_ratingCount_wessies);
        this.textViewSumAllRating= (TextView) this.findViewById(R.id.textView_sumAllRating_wessies);
        this.textViewAverageAllRating= (TextView) this.findViewById(R.id.textView_averageAllRating_wessies);
        ...
        if(isServicesOK()){
            buttonMaps.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(WestStreetLiveBarMenu.this, MapActivity.class);
    ...
    public boolean isServicesOK(){
        ...
        int available = GoogleApiAvailability.getInstance().isGooglePlayServicesAvailable(WestStreetLiveBarMenu.this);
        ...
        if(available == ConnectionResult.SUCCESS){
            ...
            Dialog dialog = GoogleApiAvailability.getInstance().getErrorDialog(WestStreetLiveBarMenu.this, available, ERROR_DIALOG_REQUEST);
            dialog.show();
        }else {
