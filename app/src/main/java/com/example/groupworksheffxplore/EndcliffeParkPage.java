...
public class EndcliffeParkPage extends AppCompatActivity {
    ...
    private ImageView endcliffe1;
    private ImageView endcliffe2;
    private ImageView endcliffe3;
    private ImageView endcliffe4;
    private ImageView endcliffe5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_endcliffe_park_info);
        slidr = Slidr.attach(this);
        ratingsDataBaseHelper = new RatingsDataBaseHelper(this);
        createNotificationChannel();


        this.buttonMaps = (Button) this.findViewById(R.id.button_maps_endcliffe);
        this.buttonFeedback = (Button) this.findViewById(R.id.button_feedback_endcliffe);
        this.buttonSubmit = (Button) this.findViewById(R.id.button_submit_endcliffe);
        this.ratingBarYours = (RatingBar) this.findViewById(R.id.ratingBar_yours_endcliffe);
        this.ratingBarAll = (RatingBar) this.findViewById(R.id.ratingBar_all_endcliffe);

        this.textViewYourCurrentRating = (TextView) this.findViewById(R.id.textView_yourCurrentRating_endcliffe);
        this.textViewRatingCount= (TextView) this.findViewById(R.id.textView_ratingCount_endcliffe);
        this.textViewSumAllRating= (TextView) this.findViewById(R.id.textView_sumAllRating_endcliffe);
        this.textViewAverageAllRating= (TextView) this.findViewById(R.id.textView_averageAllRating_endcliffe);
        ...
        if(isServicesOK()){
            buttonMaps.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(com.example.groupworksheffxplore.EndcliffeParkPage.this, MapActivity.class);
    ...
    public boolean isServicesOK(){
        ...
        int available = GoogleApiAvailability.getInstance().isGooglePlayServicesAvailable(com.example.groupworksheffxplore.EndcliffeParkPage.this);
        ...
        if(available == ConnectionResult.SUCCESS){
            ...
            Dialog dialog = GoogleApiAvailability.getInstance().getErrorDialog(com.example.groupworksheffxplore.EndcliffeParkPage.this, available, ERROR_DIALOG_REQUEST);
            dialog.show();
        }else {
