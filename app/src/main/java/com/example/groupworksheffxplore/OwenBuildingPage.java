...
public class OwenBuildingPage extends AppCompatActivity {
    ...
    private ImageView owenbuilding1;
    private ImageView owenbuilding2;
    private ImageView owenbuilding3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_owen_building_bar_info);
        slidr = Slidr.attach(this);
        ratingsDataBaseHelper = new RatingsDataBaseHelper(this);
        createNotificationChannel();

        this.owenbuilding1 = (ImageView) this.findViewById(R.id.owenbuilding1);
        this.owenbuilding2 = (ImageView) this.findViewById(R.id.owenbuilding2);
        this.owenbuilding3 = (ImageView) this.findViewById(R.id.owenbuilding3);
        this.buttonMaps = (Button) this.findViewById(R.id.button_maps_owenbuilding);
        this.buttonFeedback = (Button) this.findViewById(R.id.button_feedback_owenbuilding);
        this.buttonSubmit = (Button) this.findViewById(R.id.button_submit_owenbuilding);
        this.ratingBarYours = (RatingBar) this.findViewById(R.id.ratingBar_yours_owenbuilding);
        this.ratingBarAll = (RatingBar) this.findViewById(R.id.ratingBar_all_owenbuilding);

        this.textViewYourCurrentRating = (TextView) this.findViewById(R.id.textView_yourCurrentRating_owenbuilding);
        this.textViewRatingCount = (TextView) this.findViewById(R.id.textView_ratingCount_owenbuilding);
        this.textViewSumAllRating = (TextView) this.findViewById(R.id.textView_sumAllRating_owenbuilding);
        this.textViewAverageAllRating = (TextView) this.findViewById(R.id.textView_averageAllRating_owenbuilding);
        ...
        if (isServicesOK()) {
            buttonMaps.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(OwenBuildingPage.this, MapActivity.class);
    ...
    public boolean isServicesOK() {
        ...
        int available = GoogleApiAvailability.getInstance().isGooglePlayServicesAvailable(OwenBuildingPage.this);
        ...
        if (available == ConnectionResult.SUCCESS) {
            ...
            Dialog dialog = GoogleApiAvailability.getInstance().getErrorDialog(OwenBuildingPage.this, available, ERROR_DIALOG_REQUEST);
            dialog.show();
        } else {
