...
public class FeedBackPageHelper extends SQLiteOpenHelper {
    ...
    public static final String TABLE_COL_4 = "feedback";

    public FeedBackPageHelper(@Nullable Context context) {
        super(context, DATABASE_NAME, null, 1);
    }

    @Override
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        sqLiteDatabase.execSQL("create table " + TABLE_NAME +" (ID INTEGER PRIMARY KEY AUTOINCREMENT ,NAME TEXT,SURNAME TEXT,FEEDBACK TEXT)");
    }
    ...
    public boolean insertData(String name, String surname, String feedback){
        SQLiteDatabase db = this.getReadableDatabase();
        ContentValues contentValues = new ContentValues();

        contentValues.put(TABLE_COL_2, name);
        contentValues.put(TABLE_COL_3, surname);
        contentValues.put(TABLE_COL_4, feedback);
    ...
    public boolean updateData(String id,String name,String surname,String feedback){
