...
public class WestonParkPage extends AppCompatActivity {
    ...
    private ImageView weston1;
    private ImageView weston2;
    private ImageView weston3;
    private ImageView weston4;
    private ImageView weston5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.buttonMaps = (Button) this.findViewById(R.id.button_maps_weston);
        this.buttonFeedback = (Button) this.findViewById(R.id.button_feedback_weston);
        this.buttonSubmit = (Button) this.findViewById(R.id.button_submit_weston);
        this.ratingBarYours = (RatingBar) this.findViewById(R.id.ratingBar_yours_weston);
        this.ratingBarAll = (RatingBar) this.findViewById(R.id.ratingBar_all_weston);

        this.textViewYourCurrentRating = (TextView) this.findViewById(R.id.textView_yourCurrentRating_weston);
        this.textViewRatingCount= (TextView) this.findViewById(R.id.textView_ratingCount_weston);
        this.textViewSumAllRating= (TextView) this.findViewById(R.id.textView_sumAllRating_weston);
        this.textViewAverageAllRating= (TextView) this.findViewById(R.id.textView_averageAllRating_weston);
        ...
        if(isServicesOK()){
            buttonMaps.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(com.example.groupworksheffxplore.WestonParkPage.this, MapActivity.class);
    ...
    public boolean isServicesOK(){
        ...
        int available = GoogleApiAvailability.getInstance().isGooglePlayServicesAvailable(com.example.groupworksheffxplore.WestonParkPage.this);
        ...
        if(available == ConnectionResult.SUCCESS){
            ...
            Dialog dialog = GoogleApiAvailability.getInstance().getErrorDialog(com.example.groupworksheffxplore.WestonParkPage.this, available, ERROR_DIALOG_REQUEST);
            dialog.show();
        }else {
