...
public class NurseryTavernBarPage extends AppCompatActivity {
    ...
    private ImageView nurseryTav1;
    private ImageView nurseryTav2;
    private ImageView nurseryTav3;
    private ImageView nurseryTav4;
    private ImageView nurseryTav5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nurserytav_bar_info);
        slidr = Slidr.attach(this);
        ratingsDataBaseHelper = new RatingsDataBaseHelper(this);
        createNotificationChannel();

        this.nurseryTav1 = (ImageView) this.findViewById(R.id.nurseryTav1);
        this.nurseryTav2 = (ImageView) this.findViewById(R.id.nurseryTav2);
        this.nurseryTav3 = (ImageView) this.findViewById(R.id.nurseryTav3);
        this.nurseryTav4 = (ImageView) this.findViewById(R.id.nurseryTav4);
        this.nurseryTav5 = (ImageView) this.findViewById(R.id.nurseryTav5);
        this.buttonMaps = (Button) this.findViewById(R.id.button_maps_nurseryTav);
        this.buttonFeedback = (Button) this.findViewById(R.id.button_feedback_nurseryTav);
        this.buttonSubmit = (Button) this.findViewById(R.id.button_submit_nurseryTav);
        this.ratingBarYours = (RatingBar) this.findViewById(R.id.ratingBar_yours_nurseryTav);
        this.ratingBarAll = (RatingBar) this.findViewById(R.id.ratingBar_all_nurseryTav);

        this.textViewYourCurrentRating = (TextView) this.findViewById(R.id.textView_yourCurrentRating_nurseryTav);
        this.textViewRatingCount= (TextView) this.findViewById(R.id.textView_ratingCount_nurseryTav);
        this.textViewSumAllRating= (TextView) this.findViewById(R.id.textView_sumAllRating_nurseryTav);
        this.textViewAverageAllRating= (TextView) this.findViewById(R.id.textView_averageAllRating_nurseryTav);
        ...
        if(isServicesOK()){
            buttonMaps.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(NurseryTavernBarPage.this, MapActivity.class);
    ...
    public boolean isServicesOK(){
        ...
        int available = GoogleApiAvailability.getInstance().isGooglePlayServicesAvailable(NurseryTavernBarPage.this);
        ...
        if(available == ConnectionResult.SUCCESS){
            ...
            Dialog dialog = GoogleApiAvailability.getInstance().getErrorDialog(NurseryTavernBarPage.this, available, ERROR_DIALOG_REQUEST);
            dialog.show();
        }else {
