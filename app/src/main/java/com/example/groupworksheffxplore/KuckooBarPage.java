...
public class KuckooBarPage extends AppCompatActivity {
    ...
    private ImageView kuckoo1;
    private ImageView kuckoo2;
    private ImageView kuckoo3;
    private ImageView kuckoo4;
    private ImageView kuckoo5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kuckoo_bar_info);
        slidr = Slidr.attach(this);
        ratingsDataBaseHelper = new RatingsDataBaseHelper(this);
        createNotificationChannel();

        this.kuckoo1 = (ImageView) this.findViewById(R.id.kuckoo1);
        this.kuckoo2 = (ImageView) this.findViewById(R.id.kuckoo2);
        this.kuckoo3 = (ImageView) this.findViewById(R.id.kuckoo3);
        this.kuckoo4 = (ImageView) this.findViewById(R.id.kuckoo4);
        this.buttonMaps = (Button) this.findViewById(R.id.button_maps_kuckoo);
        this.buttonFeedback = (Button) this.findViewById(R.id.button_feedback_kuckoo);
        this.buttonSubmit = (Button) this.findViewById(R.id.button_submit_kuckoo);
        this.ratingBarYours = (RatingBar) this.findViewById(R.id.ratingBar_yours_kuckoo);
        this.ratingBarAll = (RatingBar) this.findViewById(R.id.ratingBar_all_kuckoo);

        this.textViewYourCurrentRating = (TextView) this.findViewById(R.id.textView_yourCurrentRating_kuckoo);
        this.textViewRatingCount= (TextView) this.findViewById(R.id.textView_ratingCount_kuckoo);
        this.textViewSumAllRating= (TextView) this.findViewById(R.id.textView_sumAllRating_kuckoo);
        this.textViewAverageAllRating= (TextView) this.findViewById(R.id.textView_averageAllRating_kuckoo);
        ...
        if(isServicesOK()){
            buttonMaps.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(KuckooBarPage.this, MapActivity.class);
    ...
    public boolean isServicesOK(){
        ...
        int available = GoogleApiAvailability.getInstance().isGooglePlayServicesAvailable(KuckooBarPage.this);
        ...
        if(available == ConnectionResult.SUCCESS){
            ...
            Dialog dialog = GoogleApiAvailability.getInstance().getErrorDialog(KuckooBarPage.this, available, ERROR_DIALOG_REQUEST);
            dialog.show();
        }else {
