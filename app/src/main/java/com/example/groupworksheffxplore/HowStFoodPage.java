...
public class HowStFoodPage extends AppCompatActivity {
    ...
    private ImageView HowSt1;
    private ImageView HowSt2;
    private ImageView HowSt3;
    private ImageView HowSt4;
    private ImageView HowSt5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_howst_food_info);
        slidr = Slidr.attach(this);
        ratingsDataBaseHelper = new RatingsDataBaseHelper(this);
        createNotificationChannel();


        this.buttonMaps = (Button) this.findViewById(R.id.button_maps_howst);
        this.buttonFeedback = (Button) this.findViewById(R.id.button_feedback_howst);
        this.buttonSubmit = (Button) this.findViewById(R.id.button_submit_howst);
        this.ratingBarYours = (RatingBar) this.findViewById(R.id.ratingBar_yours_howst);
        this.ratingBarAll = (RatingBar) this.findViewById(R.id.ratingBar_all_howst);

        this.textViewYourCurrentRating = (TextView) this.findViewById(R.id.textView_yourCurrentRating_howst);
        this.textViewRatingCount= (TextView) this.findViewById(R.id.textView_ratingCount_howst);
        this.textViewSumAllRating= (TextView) this.findViewById(R.id.textView_sumAllRating_howst);
        this.textViewAverageAllRating= (TextView) this.findViewById(R.id.textView_averageAllRating_howst);
        ...
        if(isServicesOK()){
            buttonMaps.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(com.example.groupworksheffxplore.HowStFoodPage.this, MapActivity.class);
    ...
    public boolean isServicesOK(){
        ...
        int available = GoogleApiAvailability.getInstance().isGooglePlayServicesAvailable(com.example.groupworksheffxplore.HowStFoodPage.this);
        ...
        if(available == ConnectionResult.SUCCESS){
            ...
            Dialog dialog = GoogleApiAvailability.getInstance().getErrorDialog(com.example.groupworksheffxplore.HowStFoodPage.this, available, ERROR_DIALOG_REQUEST);
            dialog.show();
        }else {
