...
public class DiamondBuildingPage extends AppCompatActivity {
    ...
    private ImageView diamondbuilding1;
    private ImageView diamondbuilding2;
    private ImageView diamondbuilding3;
    private ImageView diamondbuilding4;
    private ImageView diamondbuilding5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_diamond_building_info);
        slidr = Slidr.attach(this);
        ratingsDataBaseHelper = new RatingsDataBaseHelper(this);
        createNotificationChannel();

        this.diamondbuilding1 = (ImageView) this.findViewById(R.id.diamondbuilding1);
        this.diamondbuilding2 = (ImageView) this.findViewById(R.id.diamondbuilding2);
        this.diamondbuilding3 = (ImageView) this.findViewById(R.id.diamondbuilding3);
        this.diamondbuilding4 = (ImageView) this.findViewById(R.id.diamondbuilding4);
        this.diamondbuilding5 = (ImageView) this.findViewById(R.id.diamondbuilding5);
        this.buttonMaps = (Button) this.findViewById(R.id.button_maps_diamondbuilding);
        this.buttonFeedback = (Button) this.findViewById(R.id.button_feedback_diamondbuilding);
        this.buttonSubmit = (Button) this.findViewById(R.id.button_submit_diamondbuilding);
        this.ratingBarYours = (RatingBar) this.findViewById(R.id.ratingBar_yours_diamondbuilding);
        this.ratingBarAll = (RatingBar) this.findViewById(R.id.ratingBar_all_diamondbuilding);

        this.textViewYourCurrentRating = (TextView) this.findViewById(R.id.textView_yourCurrentRating_diamondbuilding);
        this.textViewRatingCount = (TextView) this.findViewById(R.id.textView_ratingCount_diamondbuilding);
        this.textViewSumAllRating = (TextView) this.findViewById(R.id.textView_sumAllRating_diamondbuilding);
        this.textViewAverageAllRating = (TextView) this.findViewById(R.id.textView_averageAllRating_diamondbuilding);
        ...
        if (isServicesOK()) {
            buttonMaps.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(DiamondBuildingPage.this, MapActivity.class);
    ...
    public boolean isServicesOK() {
        ...
        int available = GoogleApiAvailability.getInstance().isGooglePlayServicesAvailable(DiamondBuildingPage.this);
        ...
        if (available == ConnectionResult.SUCCESS) {
            ...
            Dialog dialog = GoogleApiAvailability.getInstance().getErrorDialog(DiamondBuildingPage.this, available, ERROR_DIALOG_REQUEST);
            dialog.show();
        } else {
