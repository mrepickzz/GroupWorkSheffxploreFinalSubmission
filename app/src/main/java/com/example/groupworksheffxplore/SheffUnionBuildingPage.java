...
public class SheffUnionBuildingPage extends AppCompatActivity {
    ...
    private ImageView sheffunionbuilding1;
    private ImageView sheffunionbuilding2;
    private ImageView sheffunionbuilding3;
    private ImageView sheffunionbuilding4;
    private ImageView sheffunionbuilding5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sheffield_union_building_info);
        slidr = Slidr.attach(this);
        ratingsDataBaseHelper = new RatingsDataBaseHelper(this);
        createNotificationChannel();

        this.sheffunionbuilding1 = (ImageView) this.findViewById(R.id.sheffunionbuilding1);
        this.sheffunionbuilding2 = (ImageView) this.findViewById(R.id.sheffunionbuilding2);
        this.sheffunionbuilding3 = (ImageView) this.findViewById(R.id.sheffunionbuilding3);
        this.buttonMaps = (Button) this.findViewById(R.id.button_maps_sheffunionbuilding);
        this.buttonFeedback = (Button) this.findViewById(R.id.button_feedback_sheffunionbuilding);
        this.buttonSubmit = (Button) this.findViewById(R.id.button_submit_sheffunionbuilding);
        this.ratingBarYours = (RatingBar) this.findViewById(R.id.ratingBar_yours_sheffunionbuilding);
        this.ratingBarAll = (RatingBar) this.findViewById(R.id.ratingBar_all_sheffunionbuilding);

        this.textViewYourCurrentRating = (TextView) this.findViewById(R.id.textView_yourCurrentRating_sheffunionbuilding);
        this.textViewRatingCount = (TextView) this.findViewById(R.id.textView_ratingCount_sheffunionbuilding);
        this.textViewSumAllRating = (TextView) this.findViewById(R.id.textView_sumAllRating_sheffunionbuilding);
        this.textViewAverageAllRating = (TextView) this.findViewById(R.id.textView_averageAllRating_sheffunionbuilding);
        ...
        if (isServicesOK()) {
            buttonMaps.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(SheffUnionBuildingPage.this, MapActivity.class);
    ...
    public boolean isServicesOK() {
        ...
        int available = GoogleApiAvailability.getInstance().isGooglePlayServicesAvailable(SheffUnionBuildingPage.this);
        ...
        if (available == ConnectionResult.SUCCESS) {
            ...
            Dialog dialog = GoogleApiAvailability.getInstance().getErrorDialog(SheffUnionBuildingPage.this, available, ERROR_DIALOG_REQUEST);
            dialog.show();
        } else {
